...
export default function UserPanelHeader() {
  ...
  return (
    <>
      <div
        className={`user-panel-header px-3 sm:px-10 pt-3 lg:pt-0 z-20 bg-black border-b-[1px] border-gray-400 fixed top-0 w-full transition-all duration-300 lg:h-[73px] ${
          navState ? "h-[270px]" : "h-[60px]"
        }`}
      >
        <div className="row flex items-center justify-between">
          <div className="admin-info flex items-center gap-3 sm:gap-6 relative">
            <div className="admin-icon rounded-full w-8 h-8 bg-gray-600 flex justify-center items-center border-[1px] border-gray-400">
              <LuUserRound className="text-xl text-gray-400" />
            </div>
            ...
            />
            <div
              className={`drop-menu absolute bg-gray-700 rounded-md p-1 top-[45px] w-full left-0 transition-all duration-300 h-0 opacity-0 pointer-events-none z-10 ${
                dropState &&
