...
export default function AdminPanelVerticalMenu() {
  ...
  return (
    <>
      <div
        className={`admin-vertical-menu w-[110px] bg-black min-h-svh border-r hidden lg:block border-gray-400 pt-36 relative transition-all duration-300 shrink-0 ${
          navState && "w-[250px]"
        } `}
      >
        <span
        ...
        <nav className="flex flex-col justify-between h-full">
          <ul className="flex gap-1 px-7 flex-col w-full">
            ...
            <li className="relative group">
              ...
              >
                <LuUserRound className="shrink-0 text-2xl" />
                <p
                  className={`transition-all duration-300 ${
                    navState ? "opacity-100" : "opacity-0 pointer-events-none"
                  }`}
            ...
            <li className="relative group">
              ...
              >
                <BiMoviePlay className="shrink-0 text-2xl" />
                <p
                  className={`transition-all duration-300 ${
                    navState ? "opacity-100" : "opacity-0 pointer-events-none"
                  }`}
          ...
          <div className="signout-item px-7 mb-10 relative group">
            <div
              onClick={() => signout()}
              className="signout cursor-pointer text-gray-400 flex items-center gap-3 py-3 px-4 whitespace-nowrap"
            >
